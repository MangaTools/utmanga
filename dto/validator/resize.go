...
func ValidateResizeSettings(settings dto.ResizeSettings) error {
	return validation.ValidateStruct(&settings,
		...
		validation.Field(&settings.Mode, validation.In(dto.ResizeModeLanczos, dto.ResizeModeCatmullRom,
			dto.ResizeModeMitchellNetravali, dto.ResizeModeLinear, dto.ResizeModeBox, dto.ResizeModeNearestNeighbor), validation.Required),
